  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-6 pb-4">
      ...
      <div className="mb-6">
        <button
          type="button"
          onClick={() => patch({ wantsInsurance: !data.wantsInsurance })}
          className="w-full text-left rounded-xl border-2 px-4 py-4 flex items-start gap-3 transition-all duration-150"
          style={{
            borderColor: data.wantsInsurance ? "var(--klova-primary)" : "var(--border-default)",
            background: data.wantsInsurance ? "var(--klova-primary-soft)" : "var(--surface-card)",
          }}
        >
          <div
            className="w-5 h-5 rounded border-2 flex items-center justify-center shrink-0 mt-0.5"
            style={{
              borderColor: data.wantsInsurance ? "var(--klova-primary)" : "var(--border-strong)",
              background: data.wantsInsurance ? "var(--klova-primary)" : "transparent",
            }}
          >
            {data.wantsInsurance && (
      ...
      <Alert variant="info" className="mb-5">
        After checkout, we&apos;ll match you with the best available keeper. You&apos;ll have <strong>25 minutes</strong> to complete payment.
      </Alert>
